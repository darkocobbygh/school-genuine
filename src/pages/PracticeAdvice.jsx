...
const PracticeAdvice = () => {
  return (
    <div className='bg-[#26335D] flex md:flex-col md:items-center md:justify-center'>
      <div className='md:w-[1044px] md:pb-20 pl-20 md:pl-0 pr-20 md:pr-0 pb-10'>
      <div className='md:pt-14'>
        <h6 className='text-[#FF6551] text-sm font-bold pt-8 md:pt-0'>Practice Advice</h6>
      ...
      <div className='flex gap-4 md:pt-14 flex-col md:flex-row pt-6'>
        <div >
        <div className='md:h-[300px] md:w-[348px] saless'></div>
        <div className='bg-white md:h-[300px] md:w-[348px] md:pt-4 md:justify-center md:pl-4'>
        <div className='flex justify-between md:p-4 p-4'>
            ...
            <p className='text-sm font-normal text-[#737373]'>We focus on ergonomics and meeting 
                ...
                <div className='md:pt-4 pt-2 md:pb-0 pb-4'>
                <button className='rounded-3xl border-2 md:h-[44px] md:w-[141px] w-[120px] border-[#FF6551] text-center text-[#FF6551] border-2'>Learn More &gt;</button>
                </div>  
            </div>
        </div>
        </div>
          ...
          <div className='bg-white md:h-[300px] md:w-[348px] md:pt-4 md:justify-center md:pl-6'>
           ...
           <img src={ratess} alt="" />
            ...
            <p className='text-sm font-normal text-[#737373]'>We focus on ergonomics and meeting 
                you where you work. It's only a 
                keystroke away.</p>
                <img src={sal} alt="" className='md:pt-4 pt-2' />
                <div className='flex md:gap-2 md:pt-4 pt-2'>
                <p className='text-[#BDBDBD]'>$16.48</p><p className='text-[#2435A1]'>$6.48</p>
                </div>
                <div className='md:pt-4 pt-2 pb-4 md:pb-0'>
                <button className='rounded-3xl border-2 md:h-[44px] w-[120px] md:w-[141px] border-[#FF6551] text-center text-[#FF6551] border-2'>Learn More &gt;</button>
                </div>  
            </div>
        </div>
        </div>
